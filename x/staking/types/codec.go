...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	legacy.RegisterAminoMsg(cdc, &MsgCreateValidatorForOther{}, "cosmos-sdk/MsgCreateValidatorForOther")
	legacy.RegisterAminoMsg(cdc, &MsgDelegateForOther{}, "cosmos-sdk/MsgDelegateForOther")
